...
function nsuToLowerAsciiChar(c_536871006) {
  var result_536871007 = 0;

    if ((ConstSet2[c_536871006] != undefined)) {
    result_536871007 = (c_536871006 ^ 32);
    }
    else {
      result_536871007 = c_536871006;
    }
...
function fuzzyMatch_520093708(pattern_520093710, str_520093711) {
  ...
  var result_520093715 = {Field0: 0, Field1: false};
        ...
        if (!((strIndex_520093723 < (str_520093711).length) && (patIndex_520093725 < (pattern_520093710).length))) break L2;
          L3: do {
            ...
            case 5:
              ...
              var onBoundary_520093809 = (patIndex_520093725 == ((pattern_520093710).length-1));
              if ((!(onBoundary_520093809) && (strIndex_520093723 < ((str_520093711).length-1)))) {
              var nextPatternChar_520093810 = nsuToLowerAsciiChar(pattern_520093710.charCodeAt(chckIndx(addInt(patIndex_520093725, 1), 0, (pattern_520093710).length-1)));
              var nextStrChar_520093811 = nsuToLowerAsciiChar(str_520093711.charCodeAt(chckIndx(addInt(strIndex_520093723, 1), 0, (str_520093711).length-1)));
              if (!!((ConstSet5[nextStrChar_520093811] != undefined))) Tmp4 = false; else {                Tmp4 = !((nextStrChar_520093811 == nextPatternChar_520093810));              }              onBoundary_520093809 = Tmp4;
              }
              
              if (onBoundary_520093809) {
    ...
    var colontmp__385877518 = nimMax(0, score_520093727);
    var colontmp__385877519 = (0 < score_520093727);
    result_520093715 = nimCopy(result_520093715, {Field0: colontmp__385877518, Field1: colontmp__385877519}, NTI520093712);
...
function escapeCString_385877159(x_385877162, x_385877162_Idx) {
    ...
    L1: do {
      var c_385877164 = 0;
      var i_385877524 = 0;
      var L_385877525 = (x_385877162[x_385877162_Idx]).length;
      L2: do {
          L3: while (true) {
          if (!(i_385877524 < L_385877525)) break L3;
            c_385877164 = x_385877162[x_385877162_Idx].charCodeAt(chckIndx(i_385877524, 0, (x_385877162[x_385877162_Idx]).length-1));
            switch (c_385877164) {
            case 38:
            ...
            i_385877524 = addInt(i_385877524, 1);
          }
      } while(false);
    } while(false);
...
function dosearch_385877165(value_385877167) {
  ...
  var result_385877168 = null;
    ...
    db_385877153[0] = nimCopy(null, stuff_385877174.getElementsByClassName("reference"), NTI503318760);
    contents_385877155[0] = nimCopy(null, [], NTI385877189);
    L1: do {
      var ahref_385877225 = null;
      var ahref_385877225_Idx = 0;
      var i_385877498 = 0;
      var L_385877499 = (db_385877153[0]).length;
      L2: do {
          L3: while (true) {
          if (!(i_385877498 < L_385877499)) break L3;
            ahref_385877225 = db_385877153[0]; ahref_385877225_Idx = chckIndx(i_385877498, 0, (db_385877153[0]).length-1);
            contents_385877155[0].push(ahref_385877225[ahref_385877225_Idx].getAttribute("data-doc-search-tag"));;
            i_385877498 = addInt(i_385877498, 1);
            if (!(((db_385877153[0]).length == L_385877499))) {
            failedAssertImpl_218103898(makeNimstrLit("iterators.nim(204, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
    ...
    L4: do {
      var i_385877271 = 0;
      var colontmp__385877505 = 0;
      colontmp__385877505 = (db_385877153[0]).length;
      var i_385877506 = 0;
      L5: do {
          L6: while (true) {
          if (!(i_385877506 < colontmp__385877505)) break L6;
            i_385877271 = i_385877506;
            L7: do {
              ...
              var colontmp__385877513 = fuzzyMatch_520093708(value_385877167, c_385877272);
              var score_385877273 = colontmp__385877513["Field0"];
              var matched_385877274 = colontmp__385877513["Field1"];
            ...
            i_385877506 = addInt(i_385877506, 1);
          }
      } while(false);
    } while(false);
    ...
    L8: do {
      var i_385877329 = 0;
      var colontmp__385877510 = 0;
      colontmp__385877510 = nimMin((matches_385877258).length, 29);
      var i_385877511 = 0;
      L9: do {
          L10: while (true) {
          if (!(i_385877511 < colontmp__385877510)) break L10;
            i_385877329 = i_385877511;
            ...
            i_385877511 = addInt(i_385877511, 1);
          }
      } while(false);
    } while(false);
